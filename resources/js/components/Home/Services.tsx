        ...
        >
          ...
          ${flipped ? '[transform:rotateY(180deg)]' : 'group-hover:[transform:rotateY(180deg)]'}`}
            >
                {/* Front Side */}
                <div
                    className="absolute inset-0 rounded-lg overflow-hidden shadow-lg flex flex-col items-center justify-center text-center text-white px-6 [backface-visibility:hidden]"
                ...
                {/* Back Side */}
                <div
                    className="absolute inset-0 rounded-lg shadow-lg flex items-center justify-center text-center px-6 [transform:rotateY(180deg)] [backface-visibility:hidden]"
                    style={{

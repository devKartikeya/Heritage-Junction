    ...
    return (
        <div className="bg-white text-black w-full min-h-screen overflow-x-hidden">
            ...
            <div className="p-8 text-left">
                ...
                <p className="my-5 text-base md:text-lg max-w-4xl font-semibold text-gray-600">
                    Whether you’re a solo explorer tracing spiritual trails, a family seeking cultural adventures, or a corporate group bonding through travel,
            ...
            <section className="px-6 md:px-12 py-12 bg-gray-50">
                <h2 className="text-3xl md:text-5xl font-bold text-center text-purple-600 mb-12">What we Offer ?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-purple-700 mb-2">Guided Heritage Tours</h3>
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-purple-700 mb-2">Cultural Immersion Experiences</h3>
                            <p className="text-gray-700 text-sm">
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-purple-700 mb-2">Festival & Event Packages</h3>
                            <p className="text-gray-700 text-sm">
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-purple-700 mb-2">Heritage Stays</h3>
                            <p className="text-gray-700 text-sm">
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-purple-700 mb-2">Community Engagement</h3>
                            <p className="text-gray-700 text-sm">
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-purple-700 mb-2">Customized Travel Planning</h3>
                            <p className="text-gray-700 text-sm">
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-purple-700 mb-2">Safety & Comfort</h3>
                            <p className="text-gray-700 text-sm">
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-purple-700 mb-2">Culinary Journeys</h3>
                            <p className="text-gray-700 text-sm">
